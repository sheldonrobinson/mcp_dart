...
void main() {
  group('stdio transport integration test', () {
    ...
    setUp(() async {
      ...
      client = Client(
        const Implementation(name: "test-stdio-client", version: "1.0.0"),
      );
    ...
    test(
      'client and server communicate successfully using stdio transport',
      () async {
        ...
        expect(
          tools.tools.any((tool) => tool.name == 'calculate'),
          isTrue,
